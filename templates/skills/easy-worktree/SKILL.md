---
name: easy-worktree
description: Create, run, test, or inspect isolated stacks per git worktree. Use when starting the app, running e2e tests, needing a service URL, or working on a task that needs its own isolated environment.
---
